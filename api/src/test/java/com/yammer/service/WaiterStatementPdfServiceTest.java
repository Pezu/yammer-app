...
class WaiterStatementPdfServiceTest {
    ...
    void listsTheWaitersPaymentsByTableWithTheirProducts() throws Exception {
        ...
        List<OrderItemEntity> items = List.of(
                ...
                item("Ramazzotti Amaro", "25", 2, p2), item("Ramazzotti Amaro", "25", 1, p2));
        ...
        // two orders of the same product at the same price collapse into one line
        assertTrue(text.contains("Ramazzotti Amaro 3 25.00 75.00"), text);
        assertEquals(1, text.split("Ramazzotti", -1).length - 1, text);
